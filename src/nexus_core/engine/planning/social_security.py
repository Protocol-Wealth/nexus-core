...
taxation of benefits, or spousal/survivor optimization. Pure + deterministic.
"""
...
def _breakeven_age(
    ...
    age = (monthly_later * later - monthly_earlier * earlier) / (
        monthly_later - monthly_earlier
    )
    return round(age, 1)
...
__all__ = ["social_security_claiming"]
