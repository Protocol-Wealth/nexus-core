...
- **Options** (`option_price`, `covered_call`, `cash_secured_put`, `collar`, `equity_collar_screen`) — Black-Scholes price/Greeks + overlay illustrations, plus a batch (≤25 tickers) dividend-aware theoretical collar screen. Educational, not recommendations.
